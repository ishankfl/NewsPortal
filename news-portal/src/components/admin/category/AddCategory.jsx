...
import { FiSave, FiTag, FiGlobe, FiArrowLeft } from 'react-icons/fi';
import { Formik, Form } from 'formik';
import * as Yup from 'yup';
import FormButton from '../../common/FormButton';
import FormInput from '../../common/FormInput';
import { createCategory } from '../../../api/category-services';
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex flex-col items-start gap-8 space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Create a new category for organizing articles</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          {!serverError && createCategoryMutation.isSuccess && (
            <div className="mb-6 p-4 text-green-700 bg-green-50 rounded-lg border border-green-200 flex items-start">
              ...
              <div>
                ...
                <p className="text-sm mt-1">New category has been created successfully</p>
              </div>
            </div>
          )}
