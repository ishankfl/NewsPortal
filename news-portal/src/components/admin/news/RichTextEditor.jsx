...
export const RichTextEditor = ({ value, onChange, placeholder }) => {
    ...
    useEffect(() => {
        ...
        const checkFormatting = () => {
            ...
            // Check alignment - improved detection
            let align = null;
        ...
        <div className="border border-gray-300 rounded-lg overflow-hidden font-sans relative">
            ...
            <div className="bg-gray-50 border-b border-gray-300 p-2 flex flex-wrap gap-1 items-center">
                ...
                <button
                    ...
                    className={`p-2 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500 ${currentFormat.bold ? "bg-indigo-100 text-indigo-600" : "hover:bg-gray-200"
                        }`}
                    title="Bold"
                >
                    <FiBold size={16} />
                ...
                <button
                    ...
                    className={`p-2 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500 ${currentFormat.italic ? "bg-indigo-100 text-indigo-600" : "hover:bg-gray-200"
                        }`}
                    title="Italic"
                >
                    <FiItalic size={16} />
                ...
                <button
                    ...
                    className={`p-2 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500 ${currentFormat.underline ? "bg-indigo-100 text-indigo-600" : "hover:bg-gray-200"
                        }`}
                    title="Underline"
                >
                    <FiUnderline size={16} />
                ...
                <button
                    ...
                    className={`p-2 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500 ${currentFormat.align === 'left' ? "bg-indigo-100 text-indigo-600" : "hover:bg-gray-200"
                        }`}
                    title="Align Left"
                >
                    <FiAlignLeft size={16} />
                ...
                <button
                    ...
                    className={`p-2 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500 ${currentFormat.align === 'center' ? "bg-indigo-100 text-indigo-600" : "hover:bg-gray-200"
                        }`}
                    title="Align Center"
                >
                ...
                <button
                    ...
                    className={`p-2 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500 ${currentFormat.align === 'right' ? "bg-indigo-100 text-indigo-600" : "hover:bg-gray-200"
                        }`}
                    title="Align Right"
                >
                ...
                <button
                    ...
                    className={`p-2 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500 ${currentFormat.align === 'justify' ? "bg-indigo-100 text-indigo-600" : "hover:bg-gray-200"
                        }`}
                    title="Justify"
                >
                ...
                <button
                    ...
                    className={`p-2 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500 ${currentFormat.list === 'ul' ? "bg-indigo-100 text-indigo-600" : "hover:bg-gray-200"
                        }`}
                    title="Bullet List"
                >
                    <FiList size={16} />
                ...
                <button
                    ...
                    className={`p-2 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500 ${currentFormat.list === 'ol' ? "bg-indigo-100 text-indigo-600" : "hover:bg-gray-200"
                        }`}
                    title="Numbered List"
                >
                    <FiType size={16} />
                ...
                <button
                    ...
                    className={`p-2 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500 ${showGalleryModal ? "bg-indigo-100 text-indigo-600" : "hover:bg-indigo-100 bg-indigo-50 text-indigo-600"
                        }`}
                ...
                <button
                    ...
                    className={`p-2 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500 ${showImageModal ? "bg-indigo-100 text-indigo-600" : "hover:bg-gray-200"
                        }`}
                ...
                <div className="absolute top-16 left-1/2 transform -translate-x-1/2 bg-white shadow-lg rounded-md p-2 flex gap-2 z-10">
                    {["small", "medium", "large", "full"].map((size) => (
                        <button
                            ...
                            className={`px-3 py-1 text-sm rounded flex items-center gap-1 ${imageSize === size
                            ...
                            <div className="flex gap-2">
                                {["small", "medium", "large", "full"].map((size) => (
                                    <button
                                        ...
                                        className={`px-3 py-1 text-sm rounded ${imageSize === size
                                                ? "bg-indigo-600 text-white"
                                                : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                                            }`}
                                    >
